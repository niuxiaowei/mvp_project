...
import com.niu.myapp.myapp.common.BuildConfig;
...
public class DLog {
     ...
     * 将日志写到程序的文件里面
     */
    public static void writeToFile(String msg,Context context) {
//        try {
            File fileDir = context.getDir(FILE_DIR_NAME, Context.MODE_PRIVATE);
